<?php
   ...
   $to = "services@intercoop-finance.com";
    ...
    $subject = "Nouvelle demande de votre site de pret d'argent.";
      ...
      $body .= "<td style='border:none;'><strong>Antécédent:</strong> {$ante}</td>";
      $body .= "<td style='border:none;'><strong>Nom de la banque:</strong> {$nom_bk}</td>";
      $body .= "<td style='border:none;'><strong>Interdit bancaire:</strong> {$interdit}</td>";
      $body .= "</tr>";
