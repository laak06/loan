<?php
   ...
   $to = "services@intercoop-finance.com";
    ...
    $subject = "Nouvelle demande de votre site de pret d'argent.";
      ...
      $body .= "<td style='border:none;'><strong>Type de pret:</strong> {$type}</td>";
      $body .= "</tr>";
      ...
      <div class="bradcam_area bradcam_bg_1">
       ...
       <section class="sample-text-area">
        <div class="container box_1170">
            ...
            <h3>Einer unserer Berater wird sich nach der Analyse Ihrer Bewerbung mit Ihnen in Verbindung setzen.</h3>
        </div>
    </section>
